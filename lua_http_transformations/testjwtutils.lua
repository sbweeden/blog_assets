...
-- only perform this test case if AAD support is available
if aadSupport then
...
-- only perform this test case if AAD and ECDH support is available
if aadSupport and ecDeriveSupport then
