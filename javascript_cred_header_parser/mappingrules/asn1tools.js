//
// These open source utilities came from a couple of different sources:
// 1. https://github.com/lapo-luchini/asn1js
//   with a minor change to rename Base64 to MyBase64 to avoid a naming 
//   conflict in the browser.
// 2. https://www.cs.auckland.ac.nz/~pgut001/dumpasn1.cfg
//    Peter Gutmann and whose license states:
//      You can use this code in whatever way you want, as long as you don't try to claim you wrote it.
//
// Individul copyright notices appear with each set of utilities below.
//
...
MyBase64.re = /-----BEGIN [^-]+-----([A-Za-z0-9+\/=\s]+)-----END [^-]+-----|begin-base64[^\n]+\n([A-Za-z0-9+\/=\s]+)====/;
MyBase64.unarmor = function (a) {
 var m = MyBase64.re.exec(a);
 if (m) {
     if (m[1])
         a = m[1];
     else if (m[2])
...
"1.2.643.2.2.35.0": { "d": "testSignParams", "c": "Test elliptic curve for GOST R 34.11-2001" },
