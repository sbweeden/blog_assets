...
/*
* Collection of functions useful to emulate a FIDO2 client
*/
/**
 ...
 * The authenticatorExtensions was added to test txAuthSimple transaction signing. If null, no authenticator extensions are added.
 */
function processCredentialRequestOptions(cro, up = true, uv = true, payloadHash = null, authenticatorExtensions = null) {
	...
	// flags - UP, UV, extensions
	var flags = (up ? 0x01 : 0x00) | (uv ? 0x04 : 0x00) | (authenticatorExtensions != null ? 0x80 : 0x00);
	authData.push(flags);
	...
	if (authenticatorExtensions != null) {
		let extensionBytes = bytesFromArray(new Uint8Array(CBOR.encode(authenticatorExtensions)), 0, -1);
		authData.push(...extensionBytes);		
	}
